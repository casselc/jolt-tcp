...
try {
  # Native absolute project directory; stock v0.8.1 currently fails this gate
  # in project-relative before tests run. See docs/proofs/ci-20260905.md.
