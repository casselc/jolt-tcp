; Known-SAT control: the stream closes on raw peer-closed? in the older
; invocation, before the terminal invocation can push late bytes.
...
(assert (! (not close_after_terminal_push)
           :named raw_peer_closed_closes_before_terminal_push))
